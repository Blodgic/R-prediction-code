...
et.pro.modified.df$BLOOM_Category[grepl("denial\\-*",et.pro.modified.df$classtype, perl=TRUE, ignore.case = TRUE)] <- "Infrastructure/Service Attacks"       
et.pro.modified.df$BLOOM_Category[grepl("successful-recon",et.pro.modified.df$classtype, perl=TRUE,ignore.case = TRUE)] <-  "Infrastructure/Service Attacks"
et.pro.modified.df$BLOOM_Category[grepl("network-scan",et.pro.modified.df$classtype, perl=TRUE,ignore.case = TRUE)] <- "Infrastructure/Service Attacks"
et.pro.modified.df$BLOOM_Category[grepl("scan",et.pro.modified.df$msg_type, perl=TRUE,ignore.case = TRUE)] <- "Infrastructure/Service Attacks"
